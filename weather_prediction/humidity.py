...
cols_s = [['date_time', 'maxtempC', 'mintempC', 'humidity', 'DewPointC', 'pressure'],
...
for test_loc, cols in enumerate(cols_s):
    ...
    statistical_value = [ind, mini[0], mini[1]]
    statistical_values.append(statistical_value)
    print(test_loc)

statistical_values = pd.DataFrame(statistical_values, columns=['C', 'Average Error', 'Max Difference'])
